...
/**
*/
class ProtoPluginAudioProcessor  : public juce::AudioProcessor
...
public:
    //==============================================================================
    ProtoPluginAudioProcessor();
    ~ProtoPluginAudioProcessor() override;
    ...
    juce::AudioProcessorValueTreeState apvtsParameters ;
